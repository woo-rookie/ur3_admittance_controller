...
def start_ros_controllers():
    ...
    req.start_controllers.append("ur3_cartesian_velocity_controller_sim")
    req.start_controllers.append("joint_state_controller")
    req.start_controllers.append("ur3_joint_publisher")
    req.start_controllers.append("ur3_velocity_controller")
