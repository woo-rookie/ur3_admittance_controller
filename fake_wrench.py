...
if __name__ == "__main__":
    ...
    wrench_pub = rospy.Publisher('/wrench', WrenchStamped, queue_size=4)

    # Publisher for the topic
    fake_wrench = publisherCallback()
    wrench_pub.publish(fake_wrench)
    msg = publisherCallback()
    rospy.loginfo("Publishing message {}".format(msg))
