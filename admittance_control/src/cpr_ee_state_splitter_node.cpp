...
public:
	...
	void Initialize() {
		...
		sub_ee_state_ = nh_.subscribe("/ur3/ur3_cartesian_velocity_controller_sim/ee_state" ,
		                              1000, &EE_STATE_SPLITTER::state_arm_callback, this);

		pub_ee_state_pose_ = nh_.advertise<geometry_msgs::Pose>(
		                     "/ur3/ur3_cartesian_velocity_controller_sim/ee_state_pose", 5);

		pub_ee_state_twist_ = nh_.advertise<geometry_msgs::Twist>(
		                      "/ur3/ur3_cartesian_velocity_controller_sim/ee_state_twist", 5);
